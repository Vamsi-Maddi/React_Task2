...
class calc extends Component{
    ...
    <div className="display">{displayValue}</div>
      ...
      <div className="buttons">
          ...
          <div className="row">
          <button style = {{backgroundColor:"grey",marginRight:"5px",marginLeft:"5px",textAlign:"center",width:"140px",}} onClick={this.handleClear}>C</button>
          <button style = {{backgroundColor:"grey",marginRight:"5px",marginLeft:"5px",textAlign:"center",width:"140px"}} onClick={this.handleCalculate}>=</button> 
          </div>
        </div>
      </div>
    </div>
